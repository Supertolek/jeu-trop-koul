...
func _draw() -> void:
	...
	draw_rect(Rect2(clamped_mouse_pos - camera_offset_vect, camera_size), primary_lines, false)
	draw_rect(Rect2(clamped_mouse_pos, inside_camera_size), secondary_lines, false)
